...
Route::post('/stamp/newauction', 'StampController@newauction');
Route::post('/stamp/togglefavorite', 'StampController@togglefavorite');
Route::get('/stamp/filterstamp', 'StampController@filterstamp');
